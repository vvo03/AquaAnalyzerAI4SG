...
modules = {
    "Mineral Health Effects": (
        ...
        "what are their health benefits and risks? Please also list out the other minerals found in the report"
    ),
    "Safety Thresholds": (
...
for col, (label, user_prompt) in zip(cols, modules.items()):
    if col.button(label):
        with st.spinner(f"Generating {label}…"):
            ...
            image_prompt = (
               f"Create a clean, infographic-style illustration for: {label}. "
